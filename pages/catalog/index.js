...
const sortOptions = [
  ...
  { name: 'По Рейтингу', href: '#', current: false },
  { name: 'Новинки', href: '#', current: false },
  { name: 'По цене: сначала дешевые', href: '#', current: false },
  { name: 'По цене: сначала дорогие', href: '#', current: false },
]
const subCategories = [
  { name: 'Totes', href: '#' },
  { name: 'Backpacks', href: '#' },
      ...
      <div className="max-w-2xl mx-auto py-8 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-0">
          <div className="relative z-10 flex items-baseline justify-between pb-6 border-b border-gray-200">
            <h1 className="text-2xl font-bold tracking-tight text-gray-900">Каталог вин</h1>
